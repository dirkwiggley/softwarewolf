...
export const ImageWrapCard: React.FC<ImageWrapCardProps> = ({
  ...
  const mobileContainerClasses = `block md:hidden flex flex-col gap-4 ${
    mobileImagePosition === 'top' ? 'flex-col-reverse justify-end' : 'flex-col'
  }`;
  ...
  return (
    ...
    >
      ...
      {/* 1. MOBILE ONLY VIEWPORT CONTAINER (Continuous Text Flow) */}
      ...
      {/* 2. DESKTOP ONLY VIEWPORT CONTAINER (Magazine Inline Text Wrap) */}
      <div className="hidden md:block text-sm leading-relaxed opacity-90 clear-both">
